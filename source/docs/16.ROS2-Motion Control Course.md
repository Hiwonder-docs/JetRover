...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image4.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image5.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image6.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image7.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image10.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image11.png" style="width:500px"  />

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image12.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image14.png" style="width:500px"  />

* **Program Outcome**

The program file is saved in: **ros2_ws\src\driver\controller\controller\mecanum.py**

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image32.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image37.png" style="width:500px" />

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image38.png" style="width:500px" />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image39.png" style="width:500px" />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image26.png" style="width:200px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image27.png" style="width:400px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image28.png" style="width:300px"  />

9.  The speeds of the left and right wheels of the robot can be determined as:

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image29.png" style="width:300px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image49.png" style="width:500px" />

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image50.png" style="width:500px"  />

* **Physical Characteristic**

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image51.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image40.png" style="width:500px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image54.png" style="width:500px"  />

2.  Dividing the arc length by the radius equals the angle in radians

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image55.png" style="width:500px"  />

3.  Dividing both sides of the formula by 't,' i.e., integrating with respect to time, yields.

<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image56.png" style="width:300px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image57.png" style="width:300px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image58.png" style="width:400px"  />
...
<img src="../_static/media/4/section_12_1. Kinematics Analysis\media\image73.png" style="width:500px" />
...
7. When prompted, align the robot with its front side and press Enter. The initial orientation is considered as forward, and subsequent placements should follow this initial direction.
   ...
   <img src="../_static/media/4/section_13_2. Motion Control/media/image9.png" style="width:500px" />

   <img src="../_static/media/4/section_13_2. Motion Control/media/image10.png" style="width:500px"  />

   After you successfully calibrate all direction, the following prompt will appear.

   <img src="../_static/media/4/section_13_2. Motion Control/media/image11.png" style="width:500px" />

8. Align the robot to the rear, then press Enter.

   <img src="../_static/media/4/section_13_2. Motion Control/media/image12.png" style="width:500px" />

   <img src="../_static/media/4/section_13_2. Motion Control/media/image13.png" style="width:500px"  />

9. Align the robot to the left, then hit Enter.

   <img src="../_static/media/4/section_13_2. Motion Control/media/image14.png" style="width:500px" />

   <img src="../_static/media/4/section_13_2. Motion Control/media/image15.png" style="width:500px"  />

10. Align the robot to the right, then press Enter.

    <img src="../_static/media/4/section_13_2. Motion Control/media/image16.png" style="width:500px" />

    <img src="../_static/media/4/section_13_2. Motion Control/media/image17.png" style="width:500px"  />
...
11. Lift the robot, place it facing upwards, and press Enter. When positioning vertically, be careful to avoid instability or collisions. Use your hand for support to prevent damage to the depth camera or screen.
    ...
    <img src="../_static/media/4/section_13_2. Motion Control/media/image18.png" style="width:500px" />

    <img src="../_static/media/4/section_13_2. Motion Control/media/image19.png" style="width:500px"  />

12. Place the robot as pictured, then hit Enter.

    <img src="../_static/media/4/section_13_2. Motion Control/media/image20.png" style="width:500px" />

    <img src="../_static/media/4/section_13_2. Motion Control/media/image21.png" style="width:500px"  />

13. If the below prompt shows up, it means the calibration is complete. To exit, use short-cut ‘**ctrl+c**’.

    <img src="../_static/media/4/section_13_2. Motion Control/media/image22.png" style="width:500px" />
...
14. After calibration, execute the command to verify the calibrated model.
    ...
    <img src="../_static/media/4/section_13_2. Motion Control/media/image24.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image26.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image27.png" style="width:500px"  />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image28.png" style="width:500px" />
...
9. Press ‘**I**’ key to navigate to the editing mode, and modify the value of "**angular_correctqion_factor**" to the adjusted value of "**odom_angule_scale_correction**"
   ...
   <img src="../_static/media/4/section_13_2. Motion Control/media/image31.png" style="width:500px" />
...
6. Click on "**calibrate_linear**" on the left side, and the calibration interface will appear as follows.
   ...
   <img src="../_static/media/4/section_13_2. Motion Control/media/image33.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image34.png" style="width:500px"  />
...
7. Ensure the robot is properly aligned and positioned at the starting point marker. Check the box for "**start_test**" and the robot will move forward. Observe if the robot travels in a straight line. If there is deviation, adjust the value of "**odom_linear_scale_correction**". This value adjusts the motor's scaling factor for forward movement. It is recommended to adjust this value by increments of 0.01 each time.
   ...
   <img src="../_static/media/4/section_13_2. Motion Control/media/image35.png" style="width:500px" />
...
10. Press the "**I**" key to enter edit mode and modify the value of "**linear_correction_factor**" to the adjusted value of "**odom_linear_scale_correction**."
    ...
    <img src="../_static/media/4/section_13_2. Motion Control/media/image37.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image39.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image40.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image42.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image44.png" style="width:500px" />
...
2. Enter the command to view the type, publisher, and subscribers of the "**/odom_raw**" topic. You can replace "**/odom_raw**" with the topic you want to view. The type of this topic is "**nav_msgs/msg/Odometry**".
   ...
   <img src="../_static/media/4/section_13_2. Motion Control/media/image45.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image47.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image52.png" style="width:500px" />

7. To bring the robot car to a stop, open a new terminal and set the linear velocity to '0.0'.

   <img src="../_static/media/4/section_13_2. Motion Control/media/image51.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image53.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image54.png" style="width:500px"  />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image55.png" style="width:500px"  />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image60.png" style="width:500px"  />

The Python program is saved in: **/home/ubuntu/ros2_ws/src/driver/controller/launch/controller.launch.py**

1. Import Library

   <img src="../_static/media/4/section_13_2. Motion Control/media/image61.png" style="width:500px" />

2. Main Function

   

<img src="../_static/media/4/section_13_2. Motion Control/media/image62.png" style="width:500px" />

The controller class is invoked here, and wait for the node to exit.

3. Global Parameter

<img src="../_static/media/4/section_13_2. Motion Control/media/image63.png" style="width:500px" />

<img src="../_static/media/4/section_13_2. Motion Control/media/image64.png" style="width:500px"  />

4. Function

<img src="../_static/media/4/section_13_2. Motion Control/media/image65.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image66.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image67.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image68.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image69.png" style="width:500px" />
...
<img src="../_static/media/4/section_13_2. Motion Control/media/image70.png" style="width:500px"  />
