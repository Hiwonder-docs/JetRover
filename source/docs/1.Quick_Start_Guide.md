...
:::{Note}
For specific wiring instruction, refer to [1.2.4 Wiring Instructions]().
:::
...
<img src="../_static/media/chapter_1/image36.png"  class="common_img" />
...
For exploring its functionality and viewing the program, you need to connect to the robot's system through the remote connection tool, please refer to the subsequent content under [1.6 Development Environment Setup and Configuration]().
...
<img  src="../_static/media/chapter_1/image38.png" style="width:48%;" />
<img  src="../_static/media/chapter_1/image39.png" style="width:48%;" />
</p>
...
:::{Note}
If you have purchased the robot kit without Jetson or Raspberry Pi board, please first go through the content from [1.6 Development Environment Setup and configuration]()to [1.6.7 Robot Version Configuration Tool Instruction]().
:::
...
(4) The icons in the top menu bar are respectively <img src="../_static/media/chapter_1/image71.png"  /> for robotic arm control, <img src="../_static/media/chapter_1/image72.png"  /> screenshot, <img src="../_static/media/chapter_1/image73.png"  /> close menu bar, switch to full-screen mode (this function is usually used with PS2 wireless handle).
...
(1) Enter the same directory as this document to open the installation package [nomachine_8.4.2_10_x64]() in the folder [Appendix -> 2. Remote Connection Tool]().
...
Enter the same directory as this document to open the installation package ["VNC-Viewer-6.17.731-Windows"]() in the folder ["Appendix -> 2. Remote Connection Tool"](). In the pop-up dialog box, select **'English'** as the installation language and click the **'OK'** button.
...
(1) Locate the [MobaXterm]() installation package in this folder ['2.Appendix->2. Remote Connection Tool']().
...
:::{Note}
If you are unsure the IP address, please refer to [1.5.4 LAN Mode Connection (Optional)]().
:::
...
For the remote system desktop connection, please refer to **"1.6.2 Remote Device Connection"**.
...
* If you want to learn about how to save multiple maps, please delve into the content in [4. Mapping and Navigation Courses]().
...
<img src="../_static/media/chapter_1/image214.png" class="common_img" /><img src="../_static/media/chapter_1/image215.png" class="common_img" />
...
<img src="../_static/media/chapter_1/image225.png" class="common_img" /><img src="../_static/media/chapter_1/image226.jpeg" class="common_img" />
...
<img src="../_static/media/chapter_1/image228.png" style="width:450px" class="common_img" /> <img src="../_static/media/chapter_1/image229.png" style="width:450px" class="common_img" />
...
Before starting this section, you need to use NoMachine remote desktop connection software. For detailed instructions, please refer to **"1.6 Development Environment Setup"**.
...
(1) Click <img src="../_static/media/chapter_1/image237.emf"  /> to open the command terminal. Enter the below command, and then press Enter to view each file under the home directory.
...
For more detailed STM32 code instructions, you can go through the source code, which contains very detailed comments. You can also refer to the [" STM32 Control Board Course"]() for additional information.
...
[1 Tutorial\ROS1 Courses\2 Motion Control Course\1 Kinematics Analysis]()

[1 Tutorial\ROS1 Courses\2 Motion Control Course\2 Motion Control]()

* **ROS2 Reference:**

[1 Tutorial\ROS2 Courses\2 Motion Control Course\1 Kinematics Analysis]()

[1 Tutorial\ROS2 Courses\2 Motion Control Course\2 Motion Control]()
...
**Software**: ATK-XISP (available in ["Appendix->Firmware Download Software/ATK-XISP.exe"]())
...
<img src="../_static/media/chapter_1/image259.png" class="common_img" />
...
:::{Note}
The STM32 main control board comes with pre-installed firmware. You can flash the [RRC_20240702.hex]() file located in the [**"3 Source Code Materials\STM32"**]() folder.
:::
...
<img src="../_static/media/chapter_1/image269.png" class="common_img" /><img src="../_static/media/chapter_1/image270.png" class="common_img" />
...
:::{Note}
* Before flashing the image, you can use the SSD initialization tool (the compressed file can be found in ["Appendix->Image Flashing Tools-> SSD Initialization Tool]()) to delete any unnecessary partitions on the disk, then proceed with the flashing.
...
(2) Locate the compressed file in ["Appendix->3 Image Flashing Tools->1. SSD Initialization Tool."]() After extracting it, use the **DiskGenius.exe** tool to format the SD card or solid-state drive. Be cautious to select the correct drive letter to avoid formatting your computer's drives by mistake.
