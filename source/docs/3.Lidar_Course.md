...
<img  src="../_static/media/chapter_3/section_1/media/image5.jpeg" style="width:48%;" />
<img  src="../_static/media/chapter_3/section_1/media/image6.jpeg" style="width:48%;" />
</p>

(2) Start the robot, and connect it to `NoMachine` according to the instructions provided in [1.6 Development Environment Setup and Configuration]().

<img src="../_static/media/chapter_3/section_1/media/image7.png" class="common_img" />

(3) After successful connection, double-click <img src="../_static/media/chapter_3/section_1/media/image8.png" JetRover alt="4.1" />.
...
(7) Finally, click-on <img src="../_static/media/chapter_3/section_1/media/image13.png" JetRover /> to confirm the Lidar version.
...
For instructions on app connection, please consult the tutorial located in [1.5 APP Control]().

(1) Start the robot, and access the robot system desktop using `NoMachine` according to the tutorial saved in [1.6 Development Environment Setup and Configuration]().

(2) Click-on <img src="../_static/media/chapter_3/section_1/media/image18.png" JetRover /> to start the command line terminal.
