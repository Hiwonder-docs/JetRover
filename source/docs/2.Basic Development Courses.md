...
<img src="../_static/media/2/section_156_1. ROS Robot Controller Hardware Introduction\media\image1.png" style="width:500px" />
...
4. Why are two pins of the main control chip STM32F407VET6 on the development board connected?
   ...
   <img src="../_static/media/2/section_156_1. ROS Robot Controller Hardware Introduction\media\image2.png" style="width:500px"  />

   <img src="../_static/media/2/section_156_1. ROS Robot Controller Hardware Introduction\media\image3.png" style="width:500px" />

   <img src="../_static/media/2/section_156_1. ROS Robot Controller Hardware Introduction\media\image4.png" style="width:500px" />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image1.png" style="width:500px" />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image2.png" style="width:500px" />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image3.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image4.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image5.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image6.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image7.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image8.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image9.png" style="width:500px" />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image10.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image11.png" style="width:500px"  />

The reserved interface consists of GPIO ports on the STM32F407VET6 main chip that have not yet been used.

* **TYPEC Port**

<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image12.png" style="width:500px" />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image13.png" style="width:500px" />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image14.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image15.png" style="width:500px"  />

* **CAN Port**

<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image16.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image17.png" style="width:300px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image18.png" style="width:400px"  />

This switch is used to control the car to stop.

* **4-Lane Servo Port**

<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image19.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image20.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image21.png" style="width:500px" />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image22.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image23.png" style="width:500px" />

* **Motor Drive Circuit**

<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image24.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image25.png" style="width:500px"  />

* **Serial Bus Servo Port**

<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image26.png" style="width:500px"  />
...
<img src="../_static/media/2/section_157_2. ROS Robot Controller Schematic Explanation\media\image27.png" style="width:500px"  />
...
1. Go to the folder '**Keil Installation Package and mcuisp Download Tool**', double-click the 'mdk536.exe' file.
   ...
   <img src="../_static/media/2/section_160_Development Environment Setup\media\image3.png" style="width:500px" />

2. Check the options and agree to the installation agreement.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image4.png" style="width:500px" />

3)  Choose the installation path.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image5.png" style="width:500px" />

4)  User information needs to be filled in here, you can fill it in randomly.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image6.png" style="width:500px"  />

5)  After filling in, click '**Next**' to proceed with the installation.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image7.png" style="width:500px" />

6. Wait for a moment, a prompt to install the ULink driver will pop up, click '**Install**' at this time.

   <img src="../_static/media/2/section_160_Development Environment Setup\media\image8.png" style="width:500px"  />
...
<img src="../_static/media/2/section_160_Development Environment Setup\media\image9.png" style="width:500px" />

Wait for the installation to be completed, then click-on ‘**Finish**’ button.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image10.png" style="width:500px" />

<img src="../_static/media/2/section_160_Development Environment Setup\media\image11.png" style="width:500px" />

Reopen the Keil software, then click-on **pack installer** icon.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image12.png" style="width:500px" />

Click-on ‘**Device**’ button. Then choose the correct device as pictured.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image13.png" style="width:500px" />
...
<img src="../_static/media/2/section_160_Development Environment Setup\media\image14.png" style="width:500px" />

Choose ‘**I Agree**’.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image15.png" style="width:500px" />

Select the installation path to be the same directory as Keil 5.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image16.png" style="width:500px" />

Wait for the installation to be completed.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image17.png" style="width:500px" />

Installation completed. If a prompt for upgrade appears, as shown in the following image, simply close it.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image18.png" style="width:500px" />
...
<img src="../_static/media/2/section_160_Development Environment Setup\media\image19.png" style="width:500px" />

Tick ‘**I accept the terms of this license agreement**’, and click-on ‘Next’ button.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image20.png" style="width:500px" />

You must check the first option above, then click 'Next'.

<img src="../_static/media/2/section_160_Development Environment Setup\media\image21.png" style="width:500px" />
...
<img src="../_static/media/2/section_160_Development Environment Setup\media\image22.png" style="width:500px" />
...
1. STM32 Main Controller
   ...
   <img src="../_static/media/2/section_161_First Program - Light up LED\media\image2.png" style="width:500px" />

2. The Jlink debugger and a Micro-USB data cable (self-provided) are used for code flashing.

   <img src="../_static/media/2/section_161_First Program - Light up LED\media\image3.png" style="width:500px" />
...
1. After connecting the Jlink debugger and the Micro-USB data cable, insert the DuPont female connector on the other end of the Jlink into the corresponding pin position on the STM32 main control board:
   ...
   <img src="../_static/media/2/section_161_First Program - Light up LED\media\image4.png" style="width:500px" />
   ...
   <img src="../_static/media/2/section_161_First Program - Light up LED\media\image5.png" style="width:500px" />
...
<img src="../_static/media/2/section_161_First Program - Light up LED\media\image6.png" style="width:500px" />

<p style="text-align:center">Effect Diagram 1 (LED Light Off)</p>

<img src="../_static/media/2/section_161_First Program - Light up LED\media\image7.png" style="width:500px" />
...
<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image2.png" style="width:500px"  />

Click on the "**OutPut**" option, tick the three red options below, and then click "**OK**".

<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image3.png" style="width:500px" />
...
2. In the Keil5 software interface menu bar, click on the "**Project**" option, then select "**Build Target**" from the drop-down menu that appears to compile the project, as shown in the figure below:
   ...
   <img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image4.png" style="width:500px" />

   You can also compile by clicking on the corresponding icon on the toolbar, as shown in the figure below:

   <img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image5.png" style="width:500px" />
   ...
   <img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image6.png" style="width:500px" />
...
<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image7.png" style="width:80px" />
...
<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image8.png" style="width:500px" />
...
<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image9.png" style="width:500px" />

<p style="text-align:center">[UART1]</p>

<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image10.png" style="width:500px" />
...
<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image11.png" style="width:500px" />

Click on the "**STMISP**" option in the software interface.

<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image12.png" style="width:500px" />

Select "**DTR low level reset, RTS high level to enter BootLoader**" at the bottom.

<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image13.png" style="width:500px" />

（3）Software Burning:

Click on the button inside the red box in the mcuisp software interface, and select the hex file that needs to be burned.

<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image14.png" style="width:500px" />

<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image15.png" style="width:500px" />
...
<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image16.png" style="width:500px" />

Burning in progress

<img src="../_static/media/2/section_158_Lesson 3 Project Compilation and Download\media\image17.png" style="width:500px" />
...
<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image2.png" style="width:500px" />

<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image3.jpeg" style="width:500px"  />
...
<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image4.png" style="width:500px" />

Click the "**Debug**" button, then select "**J-LINK/J-TRACE Cortex**" from the "**Use**" dropdown menu.

<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image5.png" style="width:500px"  />

Click-on ‘**Settings**’ to initiate configuration.

<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image6.png" style="width:500px" />
...
<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image7.png" style="width:500px"  />

Return to the previous interface, click "**Device**", select the corresponding chip model, and then click "**OK**".

<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image8.png" style="width:500px" />

**3. Debug**

Click the "**Debug**" button on the Keil5 software interface to enter the debugging interface.

<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image9.png" style="width:500px" />
...
<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image10.png" style="width:500px" />
...
<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image11.png" style="width:500px" />
...
<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image12.png" style="width:500px" />
...
<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image13.png" style="width:500px" />

After selecting the msg variable, right-click and choose "**Add 'msg' to**", then select the observation window Watch1 or Watch2.

<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image14.png" style="width:500px"  />

You can now observe the real-time value of msg in the Watch1 window below.

<img src="../_static/media/2/section_159_Lesson 4 SWD Simulation Debugging\media\image15.png" style="width:500px"  />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image2.png" style="width:500px" />

The LED on the controller is as below:

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image3.jpeg" style="width:500px"  />
...
1. After double-clicking to open the STM32CubeMX software, the following interface will appear:
   ...
   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image4.png" style="width:500px" />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image5.png" style="width:500px" />

Wait for the plugins to finish loading.

3.  In the input box below, enter the selected chip model: STM32F407VET6

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image6.png" style="width:500px" />

4.  After selecting the chip, you can choose the necessary chip information in this box.

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image7.png" style="width:500px" />

5.  Then click on "**Start Project**" to begin creating a new project.

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image8.png" style="width:500px" />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image9.png" style="width:500px"  />

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image10.png" style="width:500px"  />

2. Clock Configuration:

   This interface is for configuring the clock of various parts of the chip.

   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image11.png" style="width:500px" />

3. Project Manager:

   This interface is the project management interface, where various parameters for generating project files are configured.

   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image12.png" style="width:500px" />

4. Tools:

   This interface is the tools interface, where these tools can be used during the development process.

   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image13.png" style="width:500px" />
...
2. Configure the relevant parameters of the RTOS system in the configuration.
   ...
   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image14.png" style="width:500px" />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image15.png" style="width:500px" />

1. Create Task

   Select the "**Tasks and Queues**" option, then click "**Add**" in the Task section to add a task.

   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image16.png" style="width:500px" />

   The task creation interface is as below:

   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image17.png" style="width:500px" />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image18.png" style="width:500px" />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image19.png" style="width:500px" />

3)  Configure RCC

Click on the RCC option, select External High Speed Clock (HSE) as Crystal/Ceramic Resonator (passive external oscillator).

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image20.png" style="width:500px" />

4)  Configure SYS

Select TIM14 (Timer 14) as the system clock.

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image21.png" style="width:500px" />
...
3. **Clock Configuration Interface Configuration**
   ...
   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image22.png" style="width:500px" />

You only need to focus on the parameters at the end that will be used in the projects.

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image23.png" style="width:500px" />
...
4. **Project Manage Interface Configuration**
   ...
   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image24.png" style="width:500px" />

   Click-on ‘**GENERATE CODE**’ button at the upper right corner.

   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image25.png" style="width:500px" />

   After generation, click "**Open Project**" to directly open the project with Keil5 software (Keil5 needs to be installed).

   <img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image26.png" style="width:500px" />

**3. LED Program Editing**

Open main.c file in **Application / User**.

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image27.png" style="width:500px" />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image28.png" style="width:500px" />

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image29.png" style="width:500px"  />

The while loop in the `main()` function will not be reached by the system, so LED programs cannot be written here.

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image30.png" style="width:500px"  />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image31.png" style="width:500px"  />

<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image32.png" style="width:500px"  />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image33.png" style="width:500px" />
...
<img src="../_static/media/2/section_162_Lesson 5 Using a LED Blinking Program with FreeRTOS/media/image34.png" style="width:500px"  />
