...
(2) On the desktop, double-click the Tool icon <img src="../_static/media/chapter_9/section_4/media/image2.png" class="common_img" /> to open the configuration tool.
