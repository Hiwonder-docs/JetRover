...
<img src="../_static/media/chapter_9/section_1/media/image7.png" class="common_img" />

<img src="../_static/media/chapter_9/section_1/media/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_1/media/image33.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_1/media/image48.png" class="common_img" />
...
(1) Click-on <img src="../_static/media/chapter_9/section_1/media/image58.png"/> to start the command-line, the execute the following command to install `pip`:
...
(1) Click-on <img src="../_static/media/chapter_9/section_1/media/image58.png"/> to open the command-line terminal, and run the following command to create a folder.
...
<img src="../_static/media/chapter_9/section_1/media/image102.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_1/media/image112.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_1/media/image115.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_1/media/image116.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_1/media/image118.png" class="common_img" />
...
(2) Next, switch back to the virtual machine and click on the file manager <img src="../_static/media/chapter_9/section_1/media/image121.png"/> located on the left side of the screen. Select the **'test_sound'** file by left-clicking on it, then drag it into the file manager. This will save it in the home directory of the user group.
...
<img src="../_static/media/chapter_9/section_2/media/image1.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_3/media/image12.png" class="common_img" />
...
(3) Click-on <img src="../_static/media/chapter_9/section_3/media/image16.png" class="common_img" /> to start the command-line terminal.
...
(8) After modifying the `APPID` and replacing the `common.jet` file, connect to the robot's remote desktop and double-click <img src="../_static/media/chapter_9/section_3/media/image21.png"/> to open it. Locate the **"Voice Function"** option and set it to **"English"** to enable English language support for subsequent voice interactions.
...
(2) Confirm that the `APPID` in the configuration file has been modified and the `Common.jet` file has been replaced. You can refer to the document section [9.3.1 6-Channel Microphone Array Configuration (Must Read)]() for the application of `APPID` and file replacement process.
...
(3) Click-on <img src="../_static/media/chapter_9/section_3/media/image23.png"/> to open the command-line terminal.
...
② Click-on <img src="../_static/media/chapter_9/section_3/media/image40.png"/> to initiate the command-line terminal.
...
(3) Click-on <img src="../_static/media/chapter_9/section_3/media/image23.png"/> to start the command-line terminal.
...
<img src="../_static/media/chapter_9/section_3/media/image50.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_3/media/image82.png" class="common_img" />
...
(3) Click-on <img src="../_static/media/chapter_9/section_3/media/image40.png"/> to start the command-line terminal.
...
② Click-on <img src="../_static/media/chapter_9/section_3/media/image23.png" class="common_img" /> to start the command-line terminal.
...
<img src="../_static/media/chapter_9/section_3/media/image115.png" class="common_img" />

⑥ Press the **"i"** key to enter edit mode and change the value from **"1"** to **"-1."**

<img src="../_static/media/chapter_9/section_3/media/image116.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_3/media/image117.png" class="common_img" />
...
(3) Click <img src="../_static/media/chapter_9/section_3/media/image40.png" class="common_img" /> on the system desktop to open the command line terminal.
...
<img src="../_static/media/chapter_9/section_3/media/image119.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_3/media/image122.png" class="common_img" />
...
(2) Click <img src="../_static/media/chapter_9/section_3/media/image40.png" class="common_img" /> on the system desktop to open the command line terminal.
...
<img src="../_static/media/chapter_9/section_3/media/image129.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_3/media/image130.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_4/media/image1.png" class="common_img" />



(2) On the desktop, double-click the Tool icon <img src="../_static/media/chapter_9/section_4/media/image2.png"/> to open the configuration tool.
