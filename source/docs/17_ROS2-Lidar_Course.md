...
<img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image4.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image5.jpeg" style="width:500px"  />

<p style="text-align:center">A1 Lidar</p>

<img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image6.jpeg" style="width:500px"  />
...
2. Start the robot, and connect it to NoMachine according to the instructions provided in ‘**[1. Quick Start Guide->1.6 Establish Development Environment]()**’.
   ...
   <img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image7.png" style="width:500px" />
...
3. After successful connection, double-click <img src="../_static/media/4/section_14_Lidar Course\media\image8.png" style="width:50px"  />.
   ...
   <img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image9.png" style="width:500px" />

4. Select “**A1**” Click-on Lidar TAB, and select “A1”, then click-on “Save” and “Apply” in sequence.

   <img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image10.png" style="width:500px" />

5. After you reselect the Lidar version, the below prompt will appear.

   <img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image11.png" style="width:500px" />

6. After the system completes a restart, click-on “**Exit**” icon.

   <img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image12.png" style="width:500px" />
...
7. Finally, click-on <img src="../_static/media/4/section_14_Lidar Course\media\image13.png" style="width:50px" /> to confirm the Lidar version.
   ...
   <img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image14.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image15.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image16.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/4/section_14_Lidar Course\media\image17.png" style="width:500px"  />
