...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image4.png" style="width:500px"  />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image5.png" style="width:500px"  />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image6.png" style="width:500px"/>
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image7.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image10.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image11.png" style="width:500px" />

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image12.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image14.png" style="width:500px" />

* **Program Outcome**

The program file is saved to the following folder.

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image16.png" style="width:500px" />

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image17.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image25.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image37.png" style="width:500px" />

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image38.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image39.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image26.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image27.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image28.png" style="width:500px" />

9.  The speeds of the left and right wheels of the robot can be determined as:

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image29.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image49.png" style="width:500px" />

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image50.png" style="width:500px"  />

* **Physical Characteristic**

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image51.png" style="width:500px"  />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image40.png" style="width:500px"  />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image54.png" style="width:500px" />

2.  Dividing the arc length by the radius equals the angle in radians

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image55.png" style="width:500px" />

3.  Dividing both sides of the formula by 't,' i.e., integrating with respect to time, yields.

<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image56.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image57.png" style="width:500px" />
...
<img src="../_static/media/3/section_137_1. Kinematics Analysis/media/image58.png" style="width:500px" />
...
5. When prompted, align the robot with its front side and press Enter. The initial orientation is considered as forward, and subsequent placements should follow this initial direction.
   ...
   <img src="../_static/media/3/section_1/media/image7.png" style="width:500px" />

   <img src="../_static/media/3/section_1/media/image8.png" style="width:500px"  />

   After you successfully calibrate all direction, the following prompt will appear.

   <img src="../_static/media/3/section_1/media/image9.png" style="width:500px" />

6. Align the robot to the rear, then press Enter.

   <img src="../_static/media/3/section_1/media/image10.png" style="width:500px" />

   <img src="../_static/media/3/section_1/media/image11.png" style="width:500px"  />

7. Align the robot to the left, then hit Enter.

   <img src="../_static/media/3/section_1/media/image12.png" style="width:500px" />

   <img src="../_static/media/3/section_1/media/image13.png" style="width:500px"  />

8. Align the robot to the right, then press Enter.

   <img src="../_static/media/3/section_1/media/image14.png" style="width:500px" />

   <img src="../_static/media/3/section_1/media/image15.png" style="width:500px"  />
...
9. Lift the robot, place it facing upwards, and press Enter. When positioning vertically, be careful to avoid instability or collisions. Use your hand for support to prevent damage to the depth camera or screen.
   ...
   <img src="../_static/media/3/section_1/media/image16.png" style="width:500px" />

   <img src="../_static/media/3/section_1/media/image17.png" style="width:500px"  />

10. Place the robot as pictured, then hit Enter.

    <img src="../_static/media/3/section_1/media/image18.png" style="width:500px" />

    <img src="../_static/media/3/section_1/media/image19.png" style="width:500px"  />

11. If the below prompt shows up, it means the calibration is complete. To exit, use short-cut ‘**ctrl+c**’.

    <img src="../_static/media/3/section_1/media/image20.png" style="width:500px" />
...
12. After calibration, execute the command '**roslaunch hiwonder_peripherals imu.launch debug:=true**' to verify the calibrated model.
    ...
    <img src="../_static/media/3/section_1/media/image21.png" style="width:500px" />

    <img src="../_static/media/3/section_1/media/image22.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image24.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image25.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image26.png" style="width:500px" />
...
8. Press ‘**I**’ key to navigate to the editing mode, and modify the value of "**turn_factor**" to the adjusted value of "**motor_turn_scale_correction**"
   ...
   <img src="../_static/media/3/section_1/media/image29.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image32.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image33.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image34.png" style="width:500px" />
...
7. Press the "**I**" key to enter edit mode and modify the value of "**go_factor**" to the adjusted value of "**motor_go_scale_correction**."
   ...
   <img src="../_static/media/3/section_1/media/image36.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image41.png" style="width:500px" />

2)  Run the command ‘**rostopic info /imu**’ to check the type, publisher and subscriber of ‘**/imu**’ topic.

<img src="../_static/media/3/section_1/media/image42.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image43.png" style="width:500px" />

<img src="../_static/media/3/section_1/media/image44.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image47.png" style="width:500px" />

2)  Enter the command ‘**rostopic info /odom_raw**’ to check the type, publisher and subscriber of the ‘**/odom_raw**’ topic.

<img src="../_static/media/3/section_1/media/image48.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image50.png" style="width:500px" />
...
5. Open a new terminal, and enter the command ‘**rostopic pub /hiwonder_controller/cmd_vel geometry_msgs/Twist "linear:**’, then press ‘**TAB**’ key to autocomplement the parameters.
   ...
   <img src="../_static/media/3/section_1/media/image54.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image55.png" style="width:500px" />
...
<img src="../_static/media/3/section_1/media/image56.png" style="width:500px" />
